...
public class ClientModel {
    ...
    void startMandelbrot(){
        try {
            master.setMandelbrotVariable(p.xpix, p.ypix, p.stufenanzahl, p.maxIterations, p.add_iter, p.maxBetrag, p.zoomfaktor, p.cr, p.ci, p.xMinimum, p.xMaximum, p.yMinimum, p.yMaximum, p.yChunk, p.xChunk, p.master_threads, p.workersThreads);
