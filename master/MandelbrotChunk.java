...
public class MandelbrotChunk implements Runnable{
    ...
    MandelbrotChunk(Master master, int worker_yStart, int worker_yStop, int worker_xStart, int worker_xStop, int worker_stufenanzahl, int worker_maxIterations, double worker_xMinimum, double worker_xMaximum, double worker_yMinimum, double worker_yMaximum) {
        this.master = master;
